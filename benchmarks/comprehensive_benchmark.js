// Comprehensive benchmark for Node.js
// Equivalent to Sentra benchmark for fair comparison

console.log("=== NODE.JS COMPREHENSIVE BENCHMARK ===");
console.log("");
...
console.log(`Arithmetic (50k ops): ${arithmeticTime}ms`);
...
console.log(`Array (10k elements): ${arrayTime}ms`);
...
console.log(`Map (4k entries): ${mapTime}ms`);
...
console.log(`String (1k concatenations): ${stringTime}ms`);
...
console.log(`Function calls (10k): ${functionTime}ms`);
...
console.log(`Nested loops (10k iterations): ${nestedTime}ms`);
